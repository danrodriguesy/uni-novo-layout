...
const produtos = [
  {
    id: 1,
    nome: "Coxim do motor dianteiro com reforço lateral...",
    ref: "1001",
  },
  {
    id: 2,
    ...
    <div className={styles.wrapper}>
      <button className={`${styles.seta} ${styles.left}`} onClick={prev}>
        <img
          ...
          src="/imagens/universalRecomenda/arrow-left.png"
        />
      </button>
          ...
          {produtos.map((produto) => (
            <div className={styles.card} key={produto.id}>
              ...
              <div className={styles.containerImagem}>
                <img
                  src="/imagens/universalRecomenda/imagem-produto.png"
      ...
      <button className={`${styles.seta} ${styles.right}`} onClick={next}>
        <img
          ...
          src="/imagens/universalRecomenda/arrow-right.png"
        />
      </button>
